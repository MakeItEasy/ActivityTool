...
$(function(){
	...
	// 画面的错误处理
	onerror = System.Handler.HandleError;
...
function toolbar_saveActivity_click() {
	...
	var saveFunction = function(activity) {
		...
		// 提示成功信息
		System.Handler.HandleSuccessShow({title : Message.T_C_00_000_0005, msg : strInfo});
...
function toolbar_pay_click() {
	...
	var f = function() {
		...
		if(currentStatus != 4) {
			...
			// 提示保存成功信息
			System.Handler.HandleSuccessShow({title : Message.T_C_00_000_0005, msg : Message.I_A_00_000_0010});
...
function activitySendMailSuccessProcess(params) {
	...
	System.Handler.HandleSuccessShow({title : Message.T_C_00_000_0006, msg : Message.I_A_00_000_0004});
}
