	  	...
	  	initialize : function() {
			...
			if(!this.inline) {
				...
				window.top.consoleWindow = window.open("", this.logger.category, 
					"left=20,top=20,width=900,height=500,scrollbars=yes,status=no,resizable=yes;toolbar=no");
			...
			// dairugang modified
			this.logElement.style.fontSize = "12";
			...
			// dairugang modified
			this.outputElement.style.height = (this.inline) ? ("200px"):("450px");
				...
				if (text) {
					...
					switch(conversionCharacter) {
						...
						case "d":
							...
							replacement = loggingEvent.startTime.format();
							// dairugang end
							break;
						case "m":
